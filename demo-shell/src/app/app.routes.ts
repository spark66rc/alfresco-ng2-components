    ...
    { path: "preview/s/:id", component: SharedLinkViewComponent },
    {
        ...
        children: [
            ...
            },
            {
                ...
                canActivate: [AuthGuardEcm],
                loadChildren: () =>
                    import("./components/breadcrumb-demo/breadcrumb-demo.module").then(m => m.AppBreadcrumbModule)
            },
            {
                path: "notifications",
                children: [
                ...
                children: [
                    {
                        path: "",
                        loadChildren: () =>
                            import("./components/card-view/card-view.module").then(m => m.AppCardViewModule)
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        path: "",
                        loadChildren: () =>
                            import("./components/header-data/header-data.module").then(m => m.AppHeaderDataModule)
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        data: { roles: ["ACTIVITI_USER"], redirectUrl: "/error/403" },
                        loadChildren: () =>
                            import("./components/cloud/community/community.module").then(m => m.AppCommunityModule)
                    },
                    {
                        path: ":appName",
                        canActivate: [AuthGuardSsoRoleService],
            ...
            },
            {
                path: "node-selector",
                loadChildren: () =>
                    import("./components/content-node-selector/content-node-selector.module").then(
                        m => m.AppContentNodeSelectorModule
                    )
            },
            {
                path: "confirm-dialog",
            ...
            },
            {
                ...
                canActivate: [AuthGuardEcm],
                loadChildren: () =>
                    import("./components/document-list/extension-presets/extension-presets.module").then(
                        m => m.ExtensionPresetsModule
                    )
            },
            {
                path: "files/:id",
            ...
            },
            {
                path: "datatable/dnd",
                loadChildren: () =>
                    import("./components/datatable/drag-and-drop/datatable-dnd.module").then(
                        m => m.AppDataTableDndModule
                    )
            },
            {
                path: "search",
            ...
            },
            {
                path: "datatable-lazy",
                loadChildren: () =>
                    import("./components/lazy-loading/lazy-loading.module").then(m => m.LazyLoadingModule)
            },
            {
                path: "copy-content",
                loadChildren: () =>
                    import("./components/datatable/copy-content/datatable.module").then(m => m.AppDataTableCopyModule)
            },
            {
                path: "template-list",
            ...
            },
            {
                ...
                canActivate: [AuthGuardBpm],
                loadChildren: () =>
                    import("./components/task-list-demo/task-list.module").then(m => m.AppTaskListModule)
            },
            {
                path: "process-list",
                canActivate: [AuthGuardBpm],
                loadChildren: () =>
                    import("./components/process-list-demo/process-list.module").then(m => m.AppProcessListModule)
            },
            {
