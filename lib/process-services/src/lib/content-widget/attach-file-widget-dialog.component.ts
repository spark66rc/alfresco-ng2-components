...
import { ExternalAlfrescoApiService, AlfrescoApiService, LoginDialogPanelComponent, SearchService, TranslationService, SitesService, AuthenticationService } from '@alfresco/adf-core';
